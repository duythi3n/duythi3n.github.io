...
const DownCV = () => {
  ...
  return (
    <div>
      ...
      >
        <button className="group relative w-[95vw] lg:w-[160px]">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-[#c94f4f] to-[#c54444] rounded-xl opacity-50 blur-md group-hover:opacity-90 transition-all duration-700"></div>
